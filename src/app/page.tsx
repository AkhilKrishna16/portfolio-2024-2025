    ...
    <main className="max-w-lg mx-auto px-6 py-20 text-gray-900 dark:text-zinc-100">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <button
          ...
          className="mt-1 text-gray-400 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-zinc-100 transition-colors duration-150"
        >
      ...
      <p className="text-sm leading-relaxed text-gray-600 dark:text-zinc-400 mb-16">
        building with gpus, math, and deep rl. still afraid of posting on x :(
      </p>
